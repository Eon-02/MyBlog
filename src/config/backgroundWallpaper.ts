...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/m1.avif",
			"assets/images/DesktopWallpaper/m2.avif",
			"assets/images/DesktopWallpaper/m3.avif",
			"assets/images/DesktopWallpaper/m4.avif",
			"assets/images/DesktopWallpaper/m5.avif",
			"assets/images/DesktopWallpaper/m6.avif",
			"assets/images/DesktopWallpaper/m7.avif",
			"assets/images/DesktopWallpaper/m8.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		...
		// playerUrl: "/assets/videos/小さな願い.mp4",
		playerUrl: [
			"/assets/videos/小さな願い.mp4" ,
			"/assets/videos/天使の羽とクリスタル.mp4",
		],
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
